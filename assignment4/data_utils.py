...
try:
    ...
    def sample_farthest_points(points: torch.Tensor, K: int):
        """Small PyTorch fallback for pytorch3d.ops.sample_farthest_points."""
        B, N, _ = points.shape
        ...
        sampled = points[batch_idx.unsqueeze(1), selected]
...
class ColmapDataset(Dataset):
    def __init__(self, data_path, downsample_factor=8, maximum_pts_num = 3000):
        ...
        # Sample 3D points to a manageable number for the pure PyTorch renderer.
